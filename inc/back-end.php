...
{
	add_site_option( 'baweic_options', array( 'codes' => array( 'INVITATION' => array( 'maxcount'=>999999, 'leftcount'=>999999, 'users'=>'' ) ) ) );
	add_site_option( 'baweic_fields', array( 'link' => 'on', 'text_link'=> sprintf( __( 'Need an invitation code? <a href="mailto:%s">Contact us!</a>', 'baweic' ), get_option( 'admin_email' ) ) ) );
}
register_activation_hook( ___FILE___, 'baweic_activation' );

function baweic_uninstaller()
{
	delete_site_option( 'baweic_options' );
	delete_site_option( 'baweic_fields' );
}
